...
class ConsultingRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consulting_room" do
    assert_difference('ConsultingRoom.count') do
      post consulting_rooms_url, params: { consulting_room: { consultig_type_id: @consulting_room.consultig_type_id, location: @consulting_room.location, name: @consulting_room.name } }
    end
  ...
  test "should update consulting_room" do
    patch consulting_room_url(@consulting_room), params: { consulting_room: { consultig_type_id: @consulting_room.consultig_type_id, location: @consulting_room.location, name: @consulting_room.name } }
